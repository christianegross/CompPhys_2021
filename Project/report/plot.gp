...
plot '../data/potentialsu3beta2.300.dat' using 1:4:($5/100.0) w yerrorbars ls 2 title '$\beta=$2.3', potentialtot(x, a233, b233, c233) ls 2 title '',\
	 '../data/potentialsu3beta3.000.dat' using 1:4:($5/100.0) w yerrorbars ls 4 title '$\beta=$3.0', potentialtot(x, a303, b303, c303) ls 4 title '',\
	 '../data/potentialsu3beta3.500.dat' using 1:4:($5/100.0) w yerrorbars ls 5 title '$\beta=$3.5', potentialtot(x, a353, b353, c353) ls 5 title '',\
	 '../data/potentialsu3beta4.000.dat' using 1:4:($5/100.0) w yerrorbars ls 6 title '$\beta=$4.0', potentialtot(x, a403, b403, c403) ls 6 title '',\
	 '../data/potentialsu3beta4.500.dat' using 1:4:($5/100.0) w yerrorbars ls 7 title '$\beta=$4.5', potentialtot(x, a453, b453, c453) ls 7 title '',\
	 '../data/potentialsu3beta5.500.dat' using 1:4:($5/100.0) w yerrorbars ls 3 title '$\beta=$5.5', potentialtot(x, a553, b553, c553) ls 3 title ''
	 #'../data/potentialsu3beta2.000.dat' using 1:4:($5/100.0) w yerrorbars ls 1 title '$\beta=$2.0', potentialtot(x, a203, b203, c203) ls 1 title '',\
