...
\[\begin{array}{>{\displaystyle}r>{\displaystyle}c>{\displaystyle}l}
H(u)-H(u+\Delta)&=&\frac{1}{a}\left( \left(u_l-u_{l-1} \right)^2+\left(u_{l+1}-u_{l}  \right)^2-\left(u_l+\Delta-u_{l-1}  \right)^2-\left( u_{l+1}-u_{l}-\Delta \right)^2\right) \\&+&a\left( \phi_lu_l-\phi_lu_l-\phi_l\Delta\right) \\
